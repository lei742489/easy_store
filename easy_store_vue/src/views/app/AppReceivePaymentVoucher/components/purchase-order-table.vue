...
<script lang="ts" setup>
  ...
  import { listPage } from '@/views/app/AppSaleOrder/api/api-AppSaleOrder';
  import type { AppReceivePaymentAmountItem } from '../types/AppReceivePaymentAmountItem';
  ...
  watch(customerId, (newVal, oldVal) => {
    query();
  });
