...
// uni-app x 的 uni.downloadFile 已支持触发支付宝云资源的 onProgressUpdate（chunked 响应 totalBytesExpectedToWrite 为 -1），
// uvue 直接使用原生 uni.downloadFile 并复用 probeFileSize 探测总大小计算进度，无需下载兼容层
