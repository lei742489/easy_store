...
/**
 * 
 * @TableName app_purchase_order
 */
@TableName(value ="app_purchase_order")
@Data
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="app_purchase_order对象", description="进货单")
public class AppPurchaseOrder implements Serializable {
    ...
    private List<AppPurchaseOrderItem> items;

    @ApiModelProperty("订单类型：1进货，2退货")
