...
/**
 * 
 * @TableName app_payment_settle_item
 */
@TableName(value ="app_payment_settle_item")
@Data
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="app_payment_settle_item对象", description="付款单-结算帐户")
public class AppPaymentSettleItem implements Serializable {
